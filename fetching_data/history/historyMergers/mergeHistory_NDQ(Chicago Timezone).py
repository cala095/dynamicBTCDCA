...
historical = pd.read_csv(
    '../backtest-market/nq-1m_bk-1/nq-1m_bk.csv',
    delimiter=';',
    header=None,
...
live = pd.read_csv('../../live/PriceData/NDQ_data.csv', delimiter=',', header=0)
...
if not duplicates.empty:
    ...
    duplicates.to_csv('duplicate_datetimes_NDQ.csv', index=False)
    print("Duplicate datetime entries saved to for review.")
